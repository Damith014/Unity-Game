...
public class FromWorldPortTextPositioner : IFloatingTextPositioner
{
    ...
    public FromWorldPortTextPositioner(Camera camera, Vector3 worldPosition, float timeToLive, float speed)
    {
        _camera = camera;
